...
*Run 2026-06-22. Full per-universe tables, the mechanism map and the Methods note: [`output/XSMOM_UNIVERSES_REPORT.md`](output/XSMOM_UNIVERSES_REPORT.md).*
...
![map](output/xsmom_universes_map.png)
